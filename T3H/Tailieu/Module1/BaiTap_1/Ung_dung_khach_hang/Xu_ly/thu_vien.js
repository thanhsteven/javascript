...
function Xuat_Thong_tin_Cua_hang(Cua_hang, Th_Cha) {
    var Chuoi_HTML =
        `<img src="${Dia_chi_Dich_vu}/${Cua_hang.Ma_so}.png" class="my-2"/>
...
function api_Danh_sach_san_pham() {
    var Du_lieu = {};
    var Xu_ly_HTTP = new XMLHttpRequest();
...
function Xuat_Danh_sach_san_pham(Danh_sach, Th_Cha) {
    Th_Cha.innerHTML = "";
    Danh_sach.forEach(san_pham => {
        ...
        Th_Thong_bao.innerHTML = `Tổng số sản phẩm <strong>${Danh_sach.length}</strong> sản phẩm`;
    });
};
